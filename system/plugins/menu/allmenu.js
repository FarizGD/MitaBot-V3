...
let totalreg = Object.keys(db.list().user).length
        ...
        let cmd = 0, alias = 0;
        let pp = await sock.profilePictureUrl(m.sender, 'image').catch(e => 'https://files.catbox.moe/n4uynk.jpeg');
        ...
        let caption = `Hai kak ${m.pushName}, aku adalah MitaBot!
...
m.reply({
  video: { url: "https://files.catbox.moe/mizq7c.mp4" },
  caption: caption,
  gifPlayback: true,
 contextInfo: {
   ...
   sourceUrl: "https://www.youtube.com/@farizgd",
    }
  }
})
